                        ...
                        <c:when test="${articleSearchVoList.get(0).page.totalCount!=0}">
                            <c:forEach items="${articleSearchVoList}" var="a">
                                    ...
                                    <li class="entry-title">
                                        <a href="${pageContext.request.contextPath}/article/${a.articleCustom.articleId}" rel="bookmark">
            ...
            <c:if test="${articleSearchVoList[0].page.totalCount!=0}">
                ...
                <nav class="navigation pagination" role="navigation">
                    <div class="nav-links">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a class="page-numbers"
                                   href="${pageContext.request.contextPath}/p/${articleSearchVoList[0].page.pageNow-1}/search?query=${articleSearchVoList[0].query}">
                        ...
                        <c:if test="${begin >= 2 }">
                            <a class="page-numbers"
                               href="${pageContext.request.contextPath}/p/1/search?query=${articleSearchVoList[0].query}">1</a>
                        </c:if>
                        <%--显示点点点--%>
                        <c:if test="${begin  > 2 }">
                        ...
                        <c:forEach begin="${begin }" end="${end }" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a class="page-numbers"
                                       href="${pageContext.request.contextPath}/p/${i}/search?query=${articleSearchVoList[0].query}">${i }</a>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        <%-- 显示点点点 --%>
                        ...
                        <%-- 显示最后一页的数字 --%>
                        <c:if test="${end < articleSearchVoList[0].page.totalPageCount }">
                            <a href="${pageContext.request.contextPath}/p/${articleSearchVoList[0].page.totalPageCount}/search?query=${articleSearchVoList[0].query}">
