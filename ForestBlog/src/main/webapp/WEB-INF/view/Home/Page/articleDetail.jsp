    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
                        ...
                        <ul class="single-meta">
                            ...
                            <li class="edit-link">
                                <a target="_blank" class="post-edit-link"
                                   href="${pageContext.request.contextPath}/admin/article/edit/${articleDetailVo.articleCustom.articleId}">编辑</a>
                            </li>
                            </c:if>
                            <li class="comment">
                                <a href="${pageContext.request.contextPath}/article/${articleDetailVo.articleCustom.articleId}#comments"
            ...
            <div class="authorbio wow fadeInUp" data-wow-delay="0.3s">
                <img alt="${articleDetailVo.userCustom.userNickname}" src="${pageContext.request.contextPath}/${articleDetailVo.userCustom.userAvatar}"
                ...
                <ul class="postinfo">
                    ...
                    <li class="reprinted"><strong>转载请注明：</strong>
                        <a href="${pageContext.request.contextPath}/article/${articleDetailVo.articleCustom.articleId}"
                           rel="bookmark"
                           title="本文固定链接 ${pageContext.request.contextPath}/article/${articleDetailVo.articleCustom.articleId}">
                ...
                <div id="respond" class="comment-respond">
                    <h3 id="reply-title" class="comment-reply-title"><span id="reply-title-word">发表评论</span>
                        <a rel="nofollow" id="cancel-comment-reply-link"
                           href="${pageContext.request.contextPath}/article/${articleDetailVo.articleCustom.articleId}#respond"
                           style="">取消回复</a>
                    </h3>
...
<rapid:override name="footer-script">
    ...
    <script src="${pageContext.request.contextPath}/plugin/prism/prism.js"></script>
