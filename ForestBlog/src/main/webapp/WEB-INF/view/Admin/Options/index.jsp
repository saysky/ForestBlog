            ...
            <div class="layui-tab-item">
                    ...
                    <div class="layui-input-inline">
                        <div class="layui-upload">
                            <div class="layui-upload-list" style="">
                                <img class="layui-upload-img" src="${pageContext.request.contextPath}/${optionCustom.optionAboutsiteAvatar}" id="demo1" width="100"
                                     height="100">
                                <p id="demoText"></p>
                            </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <div class="layui-upload">
                            <div class="layui-upload-list" style="">
                                <img class="layui-upload-img" src="${pageContext.request.contextPath}/${optionCustom.optionAboutsiteWechat}" id="demo2" width="100"
                                     height="100">
                                <p id="demoText2"></p>
                            </div>
