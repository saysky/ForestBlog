                                    ...
                                    <li class="comment   thread-even comment-item approved">
                                        ...
                                        <div class="dashboard-comment-wrap has-row-actions">
                                            <p class="comment-meta">
                                                ...
                                                <a target="_blank" href="${c.commentCustom.commentAuthorUrl}"
                                                   ...
                                                   class="url">${c.commentCustom.commentAuthorName}</a>
                                                    ...
                                                    href="${pageContext.request.contextPath}/article/${c.commentCustom.commentArticleId}">java获取客户端ip</a>》
                                            ...
                                            <a data-comment-id="1268"
                                               href="${pageContext.request.contextPath}/admin/comment/reply/${c.commentCustom.commentId}">
                                                回复
                                            </a>
                                            </span>
                                                <span class=""> |
                                ...
                                <c:if test="${a.articleCustom.articleStatus==0}">
                                    <li>
                                        <div class="draft-title"><a
                                                href="${pageContext.request.contextPath}/admin/article/edit/${a.articleCustom.articleId}">${a.articleCustom.articleTitle}</a>
