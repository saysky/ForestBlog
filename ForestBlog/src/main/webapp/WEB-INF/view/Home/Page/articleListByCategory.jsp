            ...
            <c:when test="${articleListVoList!=null}">
                <c:choose>
                    <c:when test="${articleListVoList.size()!=0}">
                        <a href="${pageContext.request.contextPath}/category/${articleListVoList[0].categoryCustomList[0].categoryId}">${articleListVoList[0].categoryCustomList[0].categoryName}</a>
                    </c:when>
                    <c:otherwise>
                        <a href="${pageContext.request.contextPath}/category/${categoryCustom.categoryId}">${categoryCustom.categoryName}</a>
                    </c:otherwise>
                </c:choose>
                <i class="fa fa-angle-right"></i>
                文章
                        ...
                        <c:when test="${articleListVoList!=null}">
                            <c:choose>
                                <c:when test="${articleListVoList.size()!=0}">
                                    ...
                                    <span class="comment">&nbsp;&nbsp;
                                        <a href="${pageContext.request.contextPath}/article/${a.articleCustom.articleId}#comments"
                        ...
                        <c:if test="${articleListVoList.size()!=0}">
                            ...
                            <nav class="navigation pagination" role="navigation">
                                <div class="nav-links">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a class="page-numbers"
                                               href="${pageContext.request.contextPath}/category/${articleListVoList[0].categoryCustomList[0].categoryId}/p/${articleListVoList[0].page.pageNow-1}">
                                    ...
                                    <c:if test="${begin >= 2 }">
                                        <a class="page-numbers"
                                           href="${pageContext.request.contextPath}/category/${articleListVoList[0].categoryCustomList[0].categoryId}/p/1">1</a>
                                    </c:if>
                                        <%--显示点点点--%>
                                    <c:if test="${begin  > 2 }">
                                    ...
                                    <c:forEach begin="${begin }" end="${end }" var="i">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <a class="page-numbers"
                                                   href="${pageContext.request.contextPath}/category/${articleListVoList[0].categoryCustomList[0].categoryId}/p/${i}">${i }</a>
                                            </c:otherwise>
                                        </c:choose>
                                    </c:forEach>
                                        <%-- 显示点点点 --%>
                                    <c:if test="${end < articleListVoList[0].page.totalPageCount-1 }">
                                        ...
                                        <%-- 显示最后一页的数字 --%>
                                    <c:if test="${end < articleListVoList[0].page.totalPageCount }">
                                        <a href="${pageContext.request.contextPath}/category/${articleListVoList[0].categoryCustomList[0].categoryId}/p/${articleListVoList[0].page.totalPageCount}">
