    ...
    <script>
        ...
        function confirmDeleteArticleBatch() {
            ...
            if (confirm(msg)==true){
                ...
                $("#articleForm").attr("action","${pageContext.request.contextPath}/admin/article/deleteBatch");
                $("#articleForm").submit();
            }else{
                return false;
            }
        ...
        function confirmDeleteArticle(id) {
            ...
            if (confirm(msg)==true){
                //提交form
                $("#currentUrl").attr("value",currentUrl);
                $("#articleForm").attr("action","${pageContext.request.contextPath}/admin/article/delete/"+id);
                $("#articleForm").submit();
            }else{
                return false;
            }
