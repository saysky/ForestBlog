                        ...
                        <tr>
                            ...
                            <td class="dashboard-comment-wrap">
                                ...
                                <div class="row-actions">
                                     ...
                                     <span class="">
                                        <a href="${pageContext.request.contextPath}/admin/comment/reply/${c.commentCustom.commentId}">
                                            回复
                                        </a>
                                     </span>
                                     <span class=""> |
                                        <a href="${pageContext.request.contextPath}/admin/comment/edit/${c.commentCustom.commentId}">编辑</a>
                                     </span>
                                     <span class=""> |
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/article/${c.articleCustom.articleId}"
                    ...
                    <nav class="navigation pagination" role="navigation">
                        <div class="nav-links">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a class="page-numbers" href="${pageContext.request.contextPath}/admin/comment/p/${commentListVoList[0].page.pageNow-1}" >
                                ...
                                <%--显示第一页的页码--%>
                            <c:if test="${begin >= 2 }">
                                <a class="page-numbers" href="${pageContext.request.contextPath}/admin/comment/p/1">1</a>
                            </c:if>
                                <%--显示点点点--%>
                            <c:if test="${begin  > 2 }">
                            ...
                            <c:forEach begin="${begin }" end="${end }" var="i">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <a  class="page-numbers" href="${pageContext.request.contextPath}/admin/comment/p/${i}">${i}</a>
                                    </c:otherwise>
                                </c:choose>
                            </c:forEach>
                                <%-- 显示点点点 --%>
                            <c:if test="${end < commentListVoList[0].page.totalPageCount-1 }">
                                ...
                                <%-- 显示最后一页的数字 --%>
                            <c:if test="${end < commentListVoList[0].page.totalPageCount }">
                                <a href="${pageContext.request.contextPath}/admin/comment/p/${commentListVoList[0].page.totalPageCount}">
                        ...
                        <tr>
                            ...
                            <td class="dashboard-comment-wrap">
                                ...
                                <div class="row-actions">
                                    ...
                                    <span class=""> |
                                        <a href="${pageContext.request.contextPath}/admin/comment/reply/${c.commentCustom.commentId}">回复</a>
                                    </span>
                                    <span class=""> |
                                         <a href="${pageContext.request.contextPath}/admin/comment/edit/${c.commentCustom.commentId}">编辑</a>
                                    </span>
