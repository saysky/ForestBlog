                    ...
                    <li class="weixin">
                        <a title="微信" id="weixin_btn" rel="external nofollow">
                            ...
                            <div id="weixin_code" class="hide" >
                                <img src="${pageContext.request.contextPath}/${options.optionAboutsiteWechat}" alt="">
                            </div>
                        </a>
                    </li>
                    <li class="tqq">
        ...
        <div id="message" class="message-widget">
            <ul>
                ...
                <li style="border: none;">
                    <a href="${pageContext.request.contextPath}/article/${r.articleCustom.articleId}/#anchor-comment-${r.commentCustom.commentId}" title="${r.articleCustom.articleTitle}" rel="external nofollow">
