                ...
                <c:when test="${articleListVoList!=null}">
                    <c:choose>
                        <c:when test="${articleListVoList.size()!=0}">
                            <a href="${pageContext.request.contextPath}/tag/${articleListVoList[0].tagCustomList[0].tagId}">${articleListVoList[0].tagCustomList[0].tagName}</a>
                        </c:when>
                        <c:otherwise>
                            <a href="${pageContext.request.contextPath}/tag/${tagCustom.tagId}">${tagCustom.tagName}</a>
                        </c:otherwise>
                    </c:choose>
                    <i class="fa fa-angle-right"></i>
                    文章
                                        ...
                                        <figure class="thumbnail">
                                            <a href="${pageContext.request.contextPath}/article/${a.articleCustom.articleId}">
                                                <img width="280" height="210"
                                                     src="${pageContext.request.contextPath}/img/thumbnail/random/img_${a.articleCustom.articleId%400}.jpg"
                                                     class="attachment-content size-content wp-post-image"
                                                     alt="${a.articleCustom.articleTitle}">
                                            </a>
                                            <span class="cat">
                               <a href="${pageContext.request.contextPath}/category/${a.categoryCustomList[a.categoryCustomList.size()-1].categoryId}">
                                ...
                                <span class="comment">&nbsp;&nbsp;
                                    <a href="${pageContext.request.contextPath}/article/${a.articleCustom.articleId}#comments" rel="external nofollow">
                                      <i class="fa fa-comment-o"></i>
                                        ...
                                        <span class="entry-more"><a href="${pageContext.request.contextPath}/article/${a.articleCustom.articleId}"
                        ...
                        <nav class="navigation pagination" role="navigation">
                            <div class="nav-links">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <a class="page-numbers" href="${pageContext.request.contextPath}/tag/${articleListVoList[0].tagCustomList[0].tagId}/p/${articleListVoList[0].page.pageNow-1}" >
                                    ...
                                    <%--显示第一页的页码--%>
                                <c:if test="${begin >= 2 }">
                                    <a class="page-numbers" href="${pageContext.request.contextPath}/tag/${articleListVoList[0].tagCustomList[0].tagId}/p/1">1</a>
                                </c:if>
                                    <%--显示点点点--%>
                                <c:if test="${begin  > 2 }">
                                ...
                                <c:forEach begin="${begin }" end="${end }" var="i">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a  class="page-numbers" href="${pageContext.request.contextPath}/tag/${articleListVoList[0].tagCustomList[0].tagId}/p/${i}">${i }</a>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                                    <%-- 显示点点点 --%>
                                <c:if test="${end < articleListVoList[0].page.totalPageCount-1 }">
                                    ...
                                    <%-- 显示最后一页的数字 --%>
                                <c:if test="${end < articleListVoList[0].page.totalPageCount }">
                                    <a href="${pageContext.request.contextPath}/tag/${articleListVoList[0].tagCustomList[0].tagId}/p/${articleListVoList[0].page.totalPageCount}">
