                    ...
                    <div class="nav-links">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a class="page-numbers"
                                   href="${pageContext.request.contextPath}/admin/article/p/${publishedArticleListVoList[0].page.pageNow-1}">
                            ...
                            <%--显示第一页的页码--%>
                        <c:if test="${begin >= 2 }">
                            <a class="page-numbers" href="${pageContext.request.contextPath}/admin/article/p/1">1</a>
                        </c:if>
                            <%--显示点点点--%>
                        <c:if test="${begin  > 2 }">
                        ...
                        <c:forEach begin="${begin }" end="${end }" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a class="page-numbers"
                                       href="${pageContext.request.contextPath}/admin/article/p/${i}">${i}</a>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                            <%-- 显示点点点 --%>
                        <c:if test="${end < publishedArticleListVoList[0].page.totalPageCount-1 }">
                            ...
                            <%-- 显示最后一页的数字 --%>
                        <c:if test="${end < publishedArticleListVoList[0].page.totalPageCount }">
                            <a href="${pageContext.request.contextPath}/admin/article/p/${publishedArticleListVoList[0].page.totalPageCount}">
            ...
            <div class="layui-tab-item">
                <table class="layui-table">
                    ...
                    <c:forEach items="${draftArticleList}" var="a">
                        <tr>
                            <td>${a.articleCustom.articleId}</td>
                            <td><a href="${pageContext.request.contextPath}/article/${a.articleCustom.articleId}"
                                   target="_blank">
                                    ${a.articleCustom.articleTitle}
